...
- `setup.sh` - скрипт подготовки среды и тестирования (запускает все шаги автоматически)
...
- `test-rbac.sh` - автоматическое тестирование (используется внутри setup.sh)
...
- Создаёт пользователей с сертификатами
- Создаёт роли и namespace
- Создаёт привязки ролей к пользователям
